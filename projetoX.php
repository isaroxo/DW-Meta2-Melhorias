...
<head>
    ...
    <link href="assets/css/headerFundopreto.css" rel="stylesheet" type="text/css">
    <link href="assets/css/footerFundopreto.css" rel="stylesheet" type="text/css">
...
<div class="row" style="margin-left: 4vw">
    <div class="col-lg-12">
        <h1 class="title">StepUpArt</h1> <!--mudar dependendo onde clicou-->
    </div>
</div>
<div class="row" style="margin-left: 4vw">
    <div class="col-lg-12">
...
<main>
    ...
    <div class="row" id="carroussel">
        <div class="col-lg-12" id="div_carroussel">
            <img class="image_carroussel show-on-scroll" src="assets/img/Exemplo1.png" alt="ola" width="1400"
                 height="932">
            <img class="image_carroussel show-on-scroll" src="assets/img/Exemplo2.png" alt="ola" width="1400"
                 height="932">
            <img class="image_carroussel show-on-scroll" src="assets/img/Exemplo3.png" alt="ola" width="1400"
                 height="932">
            <img class="image_carroussel show-on-scroll" src="assets/img/Exemplo4.png" alt="ola" width="1400"
                 height="932">
            <img class="image_carroussel show-on-scroll" src="assets/img/Exemplo5.png" alt="ola" width="1400"
                 height="932">
            <img class="image_carroussel show-on-scroll" src="assets/img/Exemplo6.png" alt="ola" width="1400"
                 height="932">
        </div>
    </div>
    ...
    <div class="row div_1">
        <div class="div" id="div_detalhes">
            <!--Slide
            <div class="title_bloco row slide-left marquee1">
                <div class="col-lg-12" id="subtitle_detalhesCinza" onclick="showDetalhes()">
            ...
            <div class="title_bloco row slide-left marquee1">
                <div class="col-lg-12">
                    <button class="subtitle_cinza" id="subtitle_detalhesCinza" onclick="showDetalhes()">Detalhes
                    </button>
                    <h2 class="subtitle_branco">Detalhes</h2>
                    <h2 class="subtitle_cinza">Detalhes</h2>
                    <h2 class="subtitle_branco">Detalhes</h2>
                    ...
                    <h2 class="subtitle_branco">Detalhes</h2>
                    <h2 class="subtitle_branco">Detalhes</h2>
                    <h2 class="subtitle_cinza">Detalhes</h2><br>
                </div>
            </div>
    ...
    <div class="row div_1">
        ...
        <div class="div" id="div_conceito">
            <div class="title_bloco row slide-left marquee1">
                <div class="col-lg-12">
                    <button class="subtitle_cinza" id="subtitle_conceitoCinza" onclick="showConceito()">Conceito
                    </button>
            ...
            <div class="margin row">
                <div class="col-lg-8">
                    <p class="corpo textoPreto">StepUpArt consiste numa plataforma para a web que, através da recolha e
                        análise dos percursos dos utilizadores, gera uma representação gráfica dos mesmos e produz
                        uma
                        composição
                        musical.
                        De modo a melhorar a experiência social do utilizador e criar uma comunidade, os resultados
                        podem
                        ainda ser partilhados em diversas redes sociais usando o #StepUpArt.</p>
                </div>
            </div>
            <div class="row margin imagensCentro">
                <div class="col-lg-4 col-md-12 col-sm-12 centro">
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 centro">
                    <p class="corpo textoPreto centro mediaLargura" style="margin-bottom: 10px">Percurso
                        Colaborativo</p>
            ...
            <div class="row margin">
                <div class="col-lg-8" style="float: right">
                    <p class="corpo textoPreto">O utilizador poderá gerar três tipos de percursos: percurso diário,
                        percurso
    ...
    <div class="row div_1">
        ...
        <div class="div" id="div_referencias">
            <div class="title_bloco row slide-left marquee1">
                <div class="col-lg-12">
                    <button class="subtitle_cinza" id="subtitle_referenciasCinza" onclick="showReferencias()">
                        Referências
                    </button>
            ...
            <div class="row margin">
                <div class="col-lg-6" style="margin-bottom: 5vh; padding-left: 0">
                    <p class="corpo textoPreto">Este projeto académico tinha como requisito a inspiração numa ou mais
                        obras
                        apresentadas na
                    ...
                    <p class="corpo textoPreto">O trabalho de John Cage consiste na composição de uma música através da
                        ...
                        Depois é
                        escolhido um dos pontos abaixo da grelha e outro que esteja fora dela, utilizando a folha que
                        tem a
                        linha reta, criando, assim, uma composição musical.</p><br><br><br>
                    <img class="imagem" id="imagemReferencia" src="assets/img/Referencias2.png" alt="ola" width="666"
                         height="356">
                </div>
        ...
        <div class="div" id="div_website">
            ...
            <div class="margin">
                <div class="row " style="margin-bottom: 5vw">
                    <div class="col-lg-6">
                        <img class="imagem imagem_website mediaLargura" src="assets/img/Website1.png" alt="ola"
                             width="2880" height="1581"><br>
                    </div>
                    <div class="col-lg-6">
                        <img class="imagem imagem_website mediaLargura" src="assets/img/Website2.png" alt="ola"
                             width="2880" height="1580"><br>
                    </div>
                </div>
                <div class="row" style="margin-bottom: 5vw">
                    <div class="col-lg-6">
                        <img class="imagem imagem_website mediaLargura" src="assets/img/Website3.png" alt="ola"
                             width="2880" height="1579"><br>
                    </div>
                    <div class="col-lg-6">
                        <img class="imagem imagem_website mediaLargura" src="assets/img/Website4.png" alt="ola"
                             width="2880" height="1581"><br>
                    </div>
                </div>
                <div class="row center">
                    <div class="col-lg-12">
                        <a class="corpo textoPreto"
                           href="https://student.dei.uc.pt/~impereira/ProjetoP4Meta4Grupo15/index.php"><b>Acede ao
                                website aqui!</b></a>
                    </div>
                </div>
            </div>
